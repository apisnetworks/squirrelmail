...
$data_dir                 = '/var/lib/sqmail/data/';
$attachment_dir           = '/var/lib/sqmail/attach/';
$dir_hash_level           = 0;
...
$plugins[4] = 'newmail';
$plugins[5] = 'listcommands';
$plugins[6] = 'abook_import_export';
$plugins[7] = 'html_mail';
$plugins[8] = 'info';
$plugins[9] = 'compatibility';
$plugins[10] = 'bypass_trash';
$plugins[11] = 'check_quota';
$plugins[12] = 'mail_fetch';
